...
- Keep the Notion Worker tool boundary stable: `logLumaEmailHello` is the first integration point.
- Keep Luma detection and handling composable in `src/luma-mail.ts`; do not bury business logic in `src/index.ts`.
